...
export const education = [
  {
    ...
    grade: "7.64 CGPA",
    desc: "Bachelor of Technology in Computer Science (CGPA:61.8) from BIT Sindri, where I served in the Leo Club, and Participated in SIH 2024 Grand Finalist, and won multiple debate competitions.",
    degree: "Bachelor of Technology, Computer Science Engineering",
  },
  {
    id: 1,
    img: jvmLogo,
    school: "Bihar Public School, Buxar",
    date: "June 2021 - May 2023",
    grade: "61.8%",
    desc: "Completed CBSE Class XII (Physics, Chemistry, Mathematics + Physical Education) from Bihar Public with 61.8% and secured 96.4 percentile in JEE Mains.",
  ...
  },
  {
    ...
    date: "April 2021",
    grade: "75%",
    desc: "Completed CBSE Class X from DAV Public School with 75%, served as School Prefect, and won multiple debate competitions, showcasing strong leadership skills.",
    degree: "CBSE(X)",
  },
];
